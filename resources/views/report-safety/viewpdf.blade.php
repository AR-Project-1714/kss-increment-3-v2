@php
    $isPdf = false;
    $backUrl = $backUrl ?? route('safety.index');
    $pdfUrl = $pdfUrl ?? null;
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .sheet .report-paper table.grid th { font-size: 9.5px; }
        ...
        .sheet .report-paper .logo-k3 { height: 52px; }
        .sheet .report-paper td.loc-no,
        .sheet .report-paper td.loc-name { font-size: 12px; }
...
<body>
    ...
    <div class="sheet-frame">
        <div class="sheet">
            @include('report-safety.partials.report-paper', ['report' => $report, 'isPdf' => false])
        </div>
    </div>
