...
@section('content')
    <!-- MAIN APP WRAPPER -->
    <form id="mainReportForm" action="{{ route('report-ops.store') }}" method="POST" class="content d-flex flex-column align-items-start align-self-stretch gap-30 p-content">
        @csrf
        ...
        <div class="content-header">
            <div class="title-header">
                <span class="text-header fw-600 fsize-20">Form Laporan Shift Harian</span>
                <span class="note fw-300 fsize-12 text-secondary">ID: Draft Baru</span>
            </div>
            <button type="button" id="btnSaveDraft" class="btn-new d-flex justify-content-center align-items-center gap-10">
                ...
                <span class="btn-text fw-500">Simpan Sebagai Draft</span>
            </button>
        </div>
            ...
            <div class="pop-up-content d-flex flex-column gap-15">
                <div class="pop-up detail d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="fsize-10 text-secondary">ID: Draft Baru</span>
                    </div>
                </div>
