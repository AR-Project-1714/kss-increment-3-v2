    <div class="box-form form-step d-none flex-column align-items-start align-self-stretch gap-10 br-10 white-bg" id="step-muat-curah" style="box-shadow: 0 2px 4px 0 var(--blue-main-10);">
        <div class="header-form d-flex justify-content-between align-items-center align-self-stretch">
            <div class="title-form d-flex align-items-center gap-10">
                ...
                <span class="fw-600">Form Pemuatan Urea Curah</span>
                <x-form-info-popover id="info-form-ops-muat-curah" label="Informasi Form Pemuatan Urea Curah">
                    Catat pemuatan urea curah per kapal. Isi <strong>Laporan Harian</strong> tiap jam beserta <strong>COB</strong> (jumlah muat, dalam ton). Tandai status <strong>Selesai</strong> bila pekerjaan kapal sudah rampung.
                </x-form-info-popover>
            </div>
            <div class="counter-form">Form 3 dari 8</div>
        </div>
            ...
            <div class="shipment-details d-flex flex-column align-items-start align-self-stretch gap-15">
                ...
                <div class="ship-operation-status">
                    ...
                    <div class="ship-operation-status-options">
                        <label>
                            <input type="radio" name="ship_operation_urea_status_1" value="active" {{ old('ship_operation_urea_status_1') === 'active' ? 'checked' : '' }}>
