...
<head>
    ...
    <!-- Style Internal CSS -->
     <style>
        ...
        .table-input-wrapper i { font-size: 12px; color: var(--blue-main); position: relative; top: -1.2px; line-height: 1; }
        ...
        /* Field "Rentang Jam Kerja" memuat dua input jam + panah dalam satu kolom,
           jadi butuh ruang lebih lebar dari field biasa agar "00:00" tidak terpotong
           (mis. saat zoom browser 150%). Beri min-width & flex-grow lebih besar. */
        .rentang-jam-group { min-width: 280px; flex: 1.6 0 0; }
        .rentang-jam-wrapper { display: flex; align-items: center; gap: 15px; width: 100%; }
        .rentang-jam-wrapper .input-wrapper { flex: 1; min-width: 110px; border: 1px solid var(--divider); border-radius: 10px; overflow: hidden; background: var(--white); }
