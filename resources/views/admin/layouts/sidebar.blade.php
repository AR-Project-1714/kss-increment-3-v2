...
@php
    ...
    $activeMasterPane = request()->routeIs('admin.datamaster')
        && in_array(request('pane', 'karyawan'), ['karyawan', 'unit', 'truck', 'inventaris', 'lingkungan', 'safety_lokasi', 'safety_item'], true)
                    ...
                    <div class="sidebar__submenu-wrapper {{ $active === 'master' ? 'open' : '' }}">
                        ...
                        <div class="sidebar__submenu">
                            ...
                            <div class="sidebar__submenu-items">
                                ...
                                <a href="{{ route('admin.datamaster', ['pane' => 'lingkungan']) }}" class="sidebar__submenu-item {{ $active === 'master' && $activeMasterPane === 'lingkungan' ? 'active' : '' }}" data-pane="lingkungan">Data Lingkungan Operasi</a>
