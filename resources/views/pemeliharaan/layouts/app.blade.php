...
<head>
    ...
    <style>
        ...
        /* Samakan hover tombol melayang dengan Laporan Operasional: membesar (scale), bukan geser ke atas */
        .content-header.is-sticky .btn-new:hover,.content-header.is-sticky .btn-draft-save:hover{transform:scale(1.03)!important;box-shadow:0 8px 20px rgba(37,99,235,.4)!important}
